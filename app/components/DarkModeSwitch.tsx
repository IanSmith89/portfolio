	...
	return (
		<div className="flex items-center gap-2">
			...
			<input
				...
				type="checkbox"
				id="dark-mode-switch"
				className="relative w-11 h-6 py-0.5 border-0 text-transparent rounded-full cursor-pointer pl-1 dark:pl-[7px] bg-white dark:bg-none dark:checked:bg-white bg-opacity-40 dark:checked:bg-opacity-40 focus:ring-transparent focus:ring-offset-0
