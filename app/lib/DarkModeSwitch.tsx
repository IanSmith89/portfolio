	...
	return (
		<div className="flex items-center gap-2">
			...
			<input
				...
				type="checkbox"
				id="dark-mode-switch"
				className="relative w-11 h-6 py-0.5 border-0 text-transparent rounded-full cursor-pointer pl-1 dark:pl-[7px] bg-black/10 dark:checked:bg-white/40 dark:checked:bg-none dark:checked:hover:bg-white/40 dark:checked:focus:bg-white/40 focus:ring-transparent focus:ring-offset-0
